\povzetek{
    ...
    %TODO: reword again (move mention of equational theory)
}
...
\begin{otherlanguage}{english}
    ...
    In this thesis I intend to focus just on these two
    and show how to use them together with \(C*\)-algebras
    to better understand how quantum programs behave.
    In particular, I will develop a simple axiom system for determining the equality of programs.

    I will first present what quantum computation even is from a mathematical standpoint,
    then I will present a theory of quantum computation based on linear types and algebraic effects.
    Later I develop a corresponding algebraic theory with linear parameters from which we extract an equational theory for our quantum programming language.
\end{otherlanguage}
}
