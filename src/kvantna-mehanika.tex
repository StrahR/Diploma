...
%TODO: fix definition
% matija: To ni definicija tenzorskega produkta. To je kvečjemu trditev, da je Hn x Hm = H(n+m). Raje bi pisal: tenzorski produkt definiramo z linearnimi kombinacijami tenzorskih produktov vektorjev. Pa mogoče tega ne bi dal za definicijo. Potem pa poveš tisto z ekvivalentnimi zapisi, iz česar lahko sklepamo to o tenzorskem produktu Hn in Hm.
...
\begin{definition}[Kontrola]
    ...
    \begin{align*}
        ...
        \end{cases}
    \end{align*}
    Takim vratom pravimo \emph{kontrolirana} (\airquotes{na ena} in \airquotes{na nič}).
    Posebej označimo
...
Meritev bomo predstavili s škatlo, ki ima v sebi merilec.~\cite{ess-qc}. %TODO: maybe expand
