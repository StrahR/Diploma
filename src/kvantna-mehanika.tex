...
\end{definition}
\begin{remark}
    \airquotes{Ket} zapis je del \airquotes{braket} zapisa (izvira iz angl. \foreignlanguage{english}{bracket}), kjer \airquotes{bra} igra vlogo dualnega vektorja in ga pišemo \(\bra{φ}\).
\end{remark}
\begin{remark}
